...
|---|---|---|---|---|---|---|---|---|
| Eficiencia | PI1: p95 nominal <500 ms; p99 secundario <750 ms mediante límite superior IC95 | [`../protocolo-e4.md`](../protocolo-e4.md) y [`../protocolo-e4-eficiencia-poblada.md`](../protocolo-e4-eficiencia-poblada.md) | `ejecutar_eficiencia_poblada.sh`; `analizar_iso25010.py` | Histórico preservado: `raw/eficiencia_nominal_50u_5m/`; cierre correctivo: `raw/eficiencia_nominal_50u_5m_poblada/rep-01..10/`; 10 `locust_requests.csv` con SHA-256 distintos y un único dataset controlado | `analizar_iso25010.py` reconstruye cada evento GET, valida `SHA256SUMS`, software, dataset, harness y ausencia de pseudorreplicación; `iso25010-eficiencia-poblada.csv` es el derivado y `iso25010-eficiencia-poblada.sha256` su manifest global | r2--r9 (`n=8`): p95 IC95 superior 10,309339 ms <500 ms; p99 IC95 superior 22,618556 ms <750 ms; ambos **CUMPLEN**; campaña histórica preservada como antecedente | [`RESUMEN-ISO25010-E4.md`](RESUMEN-ISO25010-E4.md) | `dd2e1923d7635857f4020c7ef5c8b6efee363d7a` |
