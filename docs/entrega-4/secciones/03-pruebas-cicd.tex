...
mediante \texttt{npm run test:coverage}. Las pruebas cubren autenticación,
...
el APK release firmado como artifact de GitHub Actions. El binario está
incorporado en \path{release/apk/scli-mobile-0.1.0-release.apk} y su checksum en
\path{release/apk/SHA256SUMS.txt}; procede del run \texttt{34688947156}, para el
SHA \texttt{0b755310a0acf34da2456290a4f978475a8e17f9}, generado y verificado por
CI. GitHub Actions continúa siendo la fuente reproducible; las claves privadas
y contraseñas de firma permanecen fuera de Git.
