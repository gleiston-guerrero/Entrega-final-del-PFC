...
release oficial verificada correspondiente al punto 35 es \texttt{v1.0.1},
...
historica de una ejecucion anterior; no constituyen la release vigente
\texttt{v1.0.1}. GitHub Actions continua siendo la fuente reproducible; las
